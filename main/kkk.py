...
pg.display.set_caption("Chicken Invaders")

# Load hình nền
background_img = pg.image.load("data/background3.jpg")
background = pg.transform.scale(background_img, (WIDTH, HEIGHT))

# Load hình tàu vũ trụ   
ship_img = pg.image.load("data/phiThuyen2.png")
ship = pg.transform.scale(ship_img, (50, 50))

# Load hình gà
chicken_img = pg.image.load("data/ga.png")
chicken_img = pg.transform.scale(chicken_img, (50, 50))  

# Load hình đạn
bullet_img = pg.image.load("data/dan.png")
bullet = pg.transform.scale(bullet_img, (60, 60))

#Load hình cục máu rơi bổ sung cho tàu
heart_img = pg.image.load("data/mauBoSung.png")
heart_img = pg.transform.scale(heart_img, (50, 50))

# Đạn của gà
enemy_bullet_img = pg.image.load("data/dan_ga.png")
enemy_bullet = pg.transform.scale(enemy_bullet_img, (40, 40))

#Đạn của boss lv 1
boss_bullet_img = pg.image.load("data/danBossLV1.png")
boss_bullet = pg.transform.scale(boss_bullet_img, (40, 40))

# vụ nổ khi gà bị bắn
explosion_img = pg.image.load("data/no.png")
explosion_img = pg.transform.scale(explosion_img, (50, 50))
explosions = []
...
boss_img_lv2 = pg.image.load("data/boss2.png")
boss_img_lv2 = pg.transform.scale(boss_img_lv2, (120, 120))
...
def draw_restart_button():
    ...
    pg.draw.rect(screen, (0, 0, 255), (WIDTH // 2 - 50, HEIGHT // 2 + 50, 100, 40)) 
    ...
    return pg.Rect(WIDTH // 2 - 50, HEIGHT // 2 + 50, 100, 40)
        ...
        for event in pg.event.get():
            if event.type == pg.QUIT:
                ...
                if selected_action is not None:
                    # Assign the pg key to the action in the input_map dict.
...
def run_game():
    ...
    last_heart_spawn_time = pg.time.get_ticks() 
    ...
    last_enemy_shot_time = pg.time.get_ticks()

    boss_bullet_delay = 700 # Tốc độ bắn của boss
    last_boss_bullet_time = pg.time.get_ticks()
    ...
    while running:
        ...
        if not game_over:
                    ...
                    if isinstance(b, list) and len(b) >= 2:
                        if boss is not None and ((boss[0] - b[0]) ** 2 + (boss[1] - b[1]) ** 2) ** 0.5 < 50:
                            ...
                            if boss_health <= 0:
                                ...
                                boss_level = 2
                                boss_respawn_time = pg.time.get_ticks()  # Đặt thời gian hồi sinh cho boss lv2
            ...
            if boss is None and boss_respawn_time is not None:
                elapsed_time = pg.time.get_ticks() - boss_respawn_time
            ...
            for explosion in explosions[:]:
                ...
                if pg.time.get_ticks() - explosion[2] > 500:  # Hiển thị trong 500ms
        ...
        if not game_over:
            ...
            # Hiển thị thanh máu
            pg.draw.rect(screen, (255, 0, 0), (10, 10, ship_health * 2, 20))
            pg.draw.rect(screen, (255, 255, 255), (10, 10, 200, 20), 2)
        else:
